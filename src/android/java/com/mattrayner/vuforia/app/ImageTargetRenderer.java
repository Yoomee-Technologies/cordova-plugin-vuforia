...
import com.mattrayner.vuforia.app.utils.CubeShaders;
import com.mattrayner.vuforia.app.utils.LoadingDialogHandler;
import com.mattrayner.vuforia.app.utils.MeshObject;
import com.mattrayner.vuforia.app.utils.SampleApplication3DModel;
import com.mattrayner.vuforia.app.utils.SampleMath;
import com.mattrayner.vuforia.app.utils.SampleUtils;
import com.mattrayner.vuforia.app.utils.Teapot;
...
public class ImageTargetRenderer extends SampleRendererBase implements SampleAppRendererControl
{
  ...
  private ImageTargets mActivityMia;
    ...
    ImageTargetRenderer(ImageTargets activity, ApplicationSession session)
    {
        mActivityRef = new WeakReference<>(activity);
      mActivityMia = activity;
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        if (state.getDeviceTrackableResult() != null)
        {
           ...
           //E' DA FARE? mActivityRef.get().checkForRelocalization(statusInfo);
        ...
        for (TrackableResult result : trackableResultList)
        {
            ...
            if (result.isOfType(ImageTargetResult.getClassType()))
            {
                ...
                */
              Trackable t = result.getTrackable();
              String obj_name = t.getName();
              Log.e("FOUNDTRACKABLE", "IMAGE:" + obj_name);
              mActivityMia.imageFound(obj_name);
            }else{
              VuMarkTarget t = (VuMarkTarget) result.getTrackable();
              InstanceId instanceId = t.getInstanceId();
              String markerValue = instanceIdToValue(instanceId);
              Log.e("FOUNDTRACKABLE", "VUMARK: " + markerValue);
              mActivityMia.imageFound(markerValue);
            }
        }
    ...
    public void initRendering()
    {
     ...
     mActivityMia.loadingDialogHandler.sendEmptyMessage(LoadingDialogHandler.HIDE_LOADING_DIALOG);
